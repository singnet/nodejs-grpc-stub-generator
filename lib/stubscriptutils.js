...
import { logFilePermissions } from "./fileutils.js";
...
export const extractStubs = async (protoFilePath, output_path) => {
  ...
  logFilePermissions(node_modules_path, "before permission change --> ");
  fs.chmodSync("./node_modules", 0o755);
  logFilePermissions(node_modules_path, "after permission change --> ");
